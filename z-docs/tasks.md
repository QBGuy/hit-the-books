...
- [ ] **Logs Tab Implementation**
  - Fetch user-specific bet logs
  - Display in consistent BetCard format
...
- [ ] **Refactor Dashboard Components**
  ...
  - Extract Controls tab into separate component
  - Extract Opportunities tab into separate component
  - Extract Logs tab into separate component
