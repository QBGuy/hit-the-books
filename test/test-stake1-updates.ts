...
console.log('🧪 Testing stake_1 updates and calculations\n')

// Test 1: Bonus bet - stake_1 should not be 0
console.log('Test 1: Bonus Bet - stake_1 should not be 0')
...
console.log(`   Stake2: $${bonusResult.stake2.toFixed(2)}`)
console.log(`   Outlay: $${bonusResult.outlay.toFixed(2)} (should be stake2 only for bonus)`)
console.log(`   Profit: $${bonusResult.profit.toFixed(2)}`)
console.log(`   ✅ Stake1 is ${bonusResult.stake1 === 100 ? 'correct' : 'INCORRECT'}\n`)

// Test 2: Turnover bet - stake_1 should be full amount
console.log('Test 2: Turnover Bet - stake_1 should be full amount')
...
console.log(`   Outlay: $${turnoverResult.outlay.toFixed(2)} (should be stake1 + stake2)`)
console.log(`   Profit: $${turnoverResult.profit.toFixed(2)}`)
console.log(`   ✅ Stake1 is ${turnoverResult.stake1 === 100 ? 'correct' : 'INCORRECT'}\n`)

// Test 3: Profit_actual calculation for bonus bet
...
// Test 4: Profit_actual calculation for turnover bet
...
// Test 5: Outlay formula verification
